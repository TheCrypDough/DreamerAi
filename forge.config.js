          ...
          entryPoints: [
            {
              ...
              csp: `default-src 'self'; script-src 'self' 'unsafe-inline'; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com data:; connect-src 'self' http://localhost:8090 http://localhost:3131 ws://localhost:8090 ws://localhost:3000`
            },
          ],
        },
      },
